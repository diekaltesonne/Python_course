...
def service_init(sprite_size, full=True):
    ...
    #object_list_tmp = yaml.load(file.read()) -старая версия YAML
    object_list_tmp = yaml.load(file.read(),Loader=yaml.Loader)#новая версия YAML
    ...
    if full:
        ...
        #level_list = yaml.load(file.read())['levels'] - старая версия YAML
        level_list = yaml.load(file.read(),Loader=yaml.Loader)['levels'] # новая версия YAML
